...
class PromotionVoucherRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
           ...
           'code'=>'required|string|unique:promotion_vouchers|max:30',
           'name'=>'required|string|unique:promotion_vouchers|max:30',
