...
<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
    ...
    <li class="breadcrumb-item text-active">
        <a href="#" class="text-active">Vehicle Type</a>
    </li>
</ul>
@endsection

@section('actionButton')
<a href="{{ route('admin.vehicle_type.create') }}" class="btn btn-primary font-weight-bolder fas fa-plus">
    Create Vehicle Type
</a>
@endsection
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-title">
                    <h3 class="card-label">Vehicle Type List</h3>
                </div>
                ...
                <table class="table table-separate table-head-custom table-checkable" id="tableData">
                    <thead>
                        <tr>
                            ...
                            <th class="notexport">Vehicle Type Name</th>
                            <th>Price Per KM</th>
                            <th>Price Per Min</th>
                            <th>Base Fare</th>
                            <th>Capacity</th>
        ...
        var KTDatatablesBasicBasic = function() {
            ...
            var initTable1 = function() {
                ...
                var table1 = table.DataTable({
                    ...
                    stateSave: true,
                    ajax: {
                        url: "{{ route('admin.vehicle_type.data') }}",
                    },
                    buttons: [
                        {
                            extend: 'print',
