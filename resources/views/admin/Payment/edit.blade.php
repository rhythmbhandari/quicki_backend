...
@section('content')
    ...
    <!--begin::Form-->
    <form method="post" action=" {{ route('admin.order.update', $order) }} " id="orderForm" enctype="multipart/form-data" novalidate>
        @method("PUT")
        @include('admin.order.form',['header' => 'Update Order'])
