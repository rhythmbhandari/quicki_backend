...
<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
    ...
    <li class="breadcrumb-item text-active">
        <a href="#" class="text-active">All Notifications</a>
    </li>
</ul>
@endsection

@section('actionButton')
{{-- <a href="{{ route('admin.notification.create') }}" class="btn btn-primary font-weight-bolder fas fa-plus">
    Add Notification
</a> --}}
@endsection
...
<script>
        ...
        var KTDatatablesBasicBasic = function() {
            ...
            var initTable1 = function() {
                ...
                var table1 = table.DataTable({
                    ...
                    stateSave: true,
                    ajax: {
                        url: "{{ route('admin.all_notification.data') }}",
                    },
                    buttons: [
                        {
                            extend: 'print',
    ...
    $('body').on('click','#btnPushNotification',function(e){
        e.preventDefault();
        ...
        var text = "All users will be notified!";
        if(recipient_type != "all");
        text = "All "+recipient_type+"s will be notified!";
