...
<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
    ...
    <li class="breadcrumb-item text-active">
        <a href="#" class="text-active">Rider</a>
    </li>
</ul>
@endsection

@section('actionButton')
<a href="{{ route('admin.rider.create') }}" class="btn btn-primary font-weight-bolder fas fa-plus">
    Create Rider
</a>
@endsection
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-title">
                    <h3 class="card-label">Rider List</h3>
                </div>
                ...
                <table class="table table-separate table-head-custom table-checkable" id="tableData">
                    <thead>
                        <tr>
                            ...
                            <th class="notexport">Rider Name</th>
                            <th>Username</th>
                            <th>Email</th>
                            <th>Phone</th>
                            <th>status</th>
